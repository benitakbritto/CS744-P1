...
/users/hrpatel5/spark-3.3.0-bin-hadoop3/bin/spark-submit --master spark://10.10.1.1:7077 pagerank.py --partitions 350
echo "${BLUE} Job for Partitions = 350 finished ${NOCOLOR}"
echo "${BLUE} Removing output directory ${NOCOLOR}"
/users/hrpatel5/hadoop-3.3.4/bin/hdfs dfs -rm -r -f /output/*

echo "${BLUE} Running Job for Partitions = 400 ${NOCOLOR}"
/users/hrpatel5/spark-3.3.0-bin-hadoop3/bin/spark-submit --master spark://10.10.1.1:7077 pagerank.py --partitions 400
